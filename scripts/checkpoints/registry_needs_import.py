...
names = convert_data_to_yolo(
    input_dir=Path(r"C:\Users\fym\Desktop\XJTU-ODPlatform\data\raw\MRI\annotations"),
    output_labels_dir=Path(r"C:\Users\fym\Desktop\XJTU-ODPlatform\data\processed\coco"),
